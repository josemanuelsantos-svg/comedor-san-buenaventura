...
const {
  ...
  Baby, GraduationCap, Check, Send, Zap, ShieldAlert, Sparkles
} = LucideReact;
          ...
          <div className="space-y-6 animate-slide-right">
            ...
            {yaRegistrado && !isEditing ? (
              ...
              <>
                ...
                <div className="bg-blue-50/20 dark:bg-blue-950/5 p-5 rounded-2xl border border-blue-200/40 dark:border-blue-900/30 space-y-2">
