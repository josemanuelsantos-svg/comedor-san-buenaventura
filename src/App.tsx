    ...
    registros.forEach(r => {
      ...
      classRoster.forEach(s => {
        ...
        if (pres) {
          ...
          // El alumno estable no asiste hoy
          ausentes.push({
            id: s.id,
            nombre: s.nombre,
              ...
              <div className="space-y-4 lg:pl-6 text-left pt-4 lg:pt-0">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-[10px] font-extrabold text-slate-400 dark:text-slate-505 uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    {rosterSpecialsList.presentes.length === 0 ? (
                      ...
                      <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                        {rosterSpecialsList.presentes.map((pStudent, idx) => (
                          <div key={idx} className="p-2.5 bg-slate-50 dark:bg-slate-850 border border-slate-100 dark:border-slate-800 rounded-lg flex flex-col gap-0.5 print:bg-white print:border-slate-300">
                            <div className="flex justify-between items-center font-bold text-slate-800 dark:text-slate-200 text-xs">
                    ...
                    {rosterSpecialsList.ausentes.length === 0 ? (
                      ...
                      <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                        {rosterSpecialsList.ausentes.map((aStudent, idx) => (
                          <div key={idx} className="p-2 bg-slate-50/50 dark:bg-slate-850/40 border border-slate-100/50 dark:border-slate-800/60 rounded-lg flex justify-between items-center opacity-70 print:bg-white print:border-slate-200 print:opacity-100">
                            <div className="flex flex-col text-left">
                              <span className="font-bold text-slate-650 dark:text-slate-400 text-xs line-through print:no-underline">{aStudent.nombre}</span>
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-450 px-1.5 py-0.2 rounded text-[9px] font-bold">
                                {aStudent.clase}
                              </span>
                            </div>
                          </div>
